# 1 "Systolic-Matrix-Multiplier/design.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Systolic-Matrix-Multiplier/design.cpp" 2
# 1 "Systolic-Matrix-Multiplier/design.hpp" 1
...
# 5 "Systolic-Matrix-Multiplier/design.hpp" 2


extern "C"
{
    __attribute__((sdx_kernel("multiplier", 0))) void multiplier(
  int vec_a[8][8],
  int vec_b[8][8],
  int result[8][8],
  unsigned int
...
# 2 "Systolic-Matrix-Multiplier/design.cpp" 2

extern "C"
{
    __attribute__((sdx_kernel("multiplier", 0))) void multiplier(int vec_a[8][8],
                  int vec_b[8][8],
                  int result[8][8],
    ...
    {
#line 17 "/home/blackbox/Desktop/Systolic-Matrix-Multiplier/solution/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=multiplier
# 11 "Systolic-Matrix-Multiplier/design.cpp"
...
#pragma HLS ARRAY_PARTITION variable = localB dim = 2 complete
 ...
 VITIS_LOOP_31_1: for (int i = 0; i < 8; i++)
        {
...
#pragma HLS PIPELINE II = 1
 ...
 systolic2_load:
        ...
        VITIS_LOOP_142_3: for (int i = 0; i < 8; i++)
        {
            VITIS_LOOP_144_4: for (int j = 0; j < 8; j++)
            {
#pragma HLS UNROLL factor = 8

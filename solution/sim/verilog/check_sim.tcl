...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.multiplier.autotvin_gmem1.dat"
         "c.multiplier.autotvin_gmem2.dat"
         "c.multiplier.autotvin_vec_a.dat"
         "c.multiplier.autotvin_vec_b.dat"
         "c.multiplier.autotvin_result.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.multiplier.autotvout_gmem3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

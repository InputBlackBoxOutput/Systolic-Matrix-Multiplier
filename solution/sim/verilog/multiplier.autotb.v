...
`define AESL_DEPTH_vec_a 1
`define AESL_DEPTH_vec_b 1
`define AESL_DEPTH_result 1
`define AESL_DEPTH_vector_len 1
...
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.multiplier.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem2_out_wrapc  "../tv/rtldatafile/rtl.multiplier.autotvin_gmem2.dat"
`define AUTOTB_TVIN_vec_a_out_wrapc  "../tv/rtldatafile/rtl.multiplier.autotvin_vec_a.dat"
`define AUTOTB_TVIN_vec_b_out_wrapc  "../tv/rtldatafile/rtl.multiplier.autotvin_vec_b.dat"
`define AUTOTB_TVIN_result_out_wrapc  "../tv/rtldatafile/rtl.multiplier.autotvin_result.dat"
`define AUTOTB_TVOUT_gmem3  "../tv/cdatafile/c.multiplier.autotvout_gmem3.dat"
`define AUTOTB_TVOUT_gmem3_out_wrapc  "../tv/rtldatafile/rtl.multiplier.autotvout_gmem3.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_gmem2 = 4;
parameter LENGTH_gmem3 = 4;
parameter LENGTH_result = 1;
parameter LENGTH_vec_a = 1;
parameter LENGTH_vec_b = 1;
parameter LENGTH_vector_len = 1;
...
reg end_vec_a;
reg [31:0] size_vec_a;
reg [31:0] size_vec_a_backup;
reg end_vec_b;
reg [31:0] size_vec_b;
reg [31:0] size_vec_b_backup;
reg end_result;
